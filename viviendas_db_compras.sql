...
CREATE TABLE `compras` (
  ...
  CONSTRAINT `compras_ibfk_1` FOREIGN KEY (`idvivienda`) REFERENCES `viviendas` (`idvivienda`),
  CONSTRAINT `compras_ibfk_2` FOREIGN KEY (`idcomprador`) REFERENCES `compradores` (`idcomprador`)
